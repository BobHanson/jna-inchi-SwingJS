...
var jnainchiModule = (() => {
  ...
  return (
function(jnainchiModule) {
  jnainchiModule = jnainchiModule || {};
...
var Module = typeof jnainchiModule != 'undefined' ? jnainchiModule : {};
...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_inchi_from_inchi')) {
        Object.defineProperty(Module['ready'], '_inchi_from_inchi', { configurable: true, get: function() { abort('You are getting _inchi_from_inchi on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_inchi_from_inchi', { configurable: true, set: function() { abort('You are setting _inchi_from_inchi on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_model_from_inchi')) {
        Object.defineProperty(Module['ready'], '_model_from_inchi', { configurable: true, get: function() { abort('You are getting _model_from_inchi on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_model_from_inchi', { configurable: true, set: function() { abort('You are setting _model_from_inchi on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_inchi_from_molfile')) {
        Object.defineProperty(Module['ready'], '_inchi_from_molfile', { configurable: true, get: function() { abort('You are getting _inchi_from_molfile on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_inchi_from_molfile', { configurable: true, set: function() { abort('You are setting _inchi_from_molfile on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_inchikey_from_inchi')) {
        Object.defineProperty(Module['ready'], '_inchikey_from_inchi', { configurable: true, get: function() { abort('You are getting _inchikey_from_inchi on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_inchikey_from_inchi', { configurable: true, set: function() { abort('You are setting _inchikey_from_inchi on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_molfile_from_inchi')) {
        Object.defineProperty(Module['ready'], '_molfile_from_inchi', { configurable: true, get: function() { abort('You are getting _molfile_from_inchi on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_molfile_from_inchi', { configurable: true, set: function() { abort('You are setting _molfile_from_inchi on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_molfile_from_auxinfo')) {
        Object.defineProperty(Module['ready'], '_molfile_from_auxinfo', { configurable: true, get: function() { abort('You are getting _molfile_from_auxinfo on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_molfile_from_auxinfo', { configurable: true, set: function() { abort('You are setting _molfile_from_auxinfo on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
var asmLibraryArg = {
  ...
  "to_json_inchi": to_json_inchi,
  "to_json_inchikey": to_json_inchikey,
  "to_json_model": to_json_model,
  "to_json_molfile": to_json_molfile
};
var asm = createWasm();
/** @type {function(...*):?} */
...
/** @type {function(...*):?} */
var _inchi_from_inchi = Module["_inchi_from_inchi"] = createExportWrapper("inchi_from_inchi");

/** @type {function(...*):?} */
var _inchikey_from_inchi = Module["_inchikey_from_inchi"] = createExportWrapper("inchikey_from_inchi");

/** @type {function(...*):?} */
var _molfile_from_inchi = Module["_molfile_from_inchi"] = createExportWrapper("molfile_from_inchi");

/** @type {function(...*):?} */
var _molfile_from_auxinfo = Module["_molfile_from_auxinfo"] = createExportWrapper("molfile_from_auxinfo");
...
run();
  ...
  return jnainchiModule.ready
}
);
})();
if (typeof exports === 'object' && typeof module === 'object')
  module.exports = jnainchiModule;
else if (typeof define === 'function' && define['amd'])
  define([], function() { return jnainchiModule; });
else if (typeof exports === 'object')
  exports["jnainchiModule"] = jnainchiModule;
