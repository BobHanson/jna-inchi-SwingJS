 ...
 * there were just two hitches - see TODO notes:
 * 
 ...
 * 
 * IXA_INCHIKEYBUILDER.getExtra1(...)
 * 
 * IXA_INCHIKEYBUILDER.getExtra2(...)
 * 
 * 2) Currently there is no IXA access to (ichilnct.c) Get_inchi_Input_FromAuxInfo. 
 * 
...
public class InchiAPI {
	...
	public static InchiKeyOutput inchiToInchiKey(String inchi) {
		...
		try {
			...
			return new InchiKeyOutput(key, InchiKeyStatus.of((byte)0), "", "");
		} finally {
			IXA.IXA_STATUS_Destroy(hStatus);
